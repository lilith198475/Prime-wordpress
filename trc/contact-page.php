                    ...
                    <div class="col-sm-9">
                 		<div class="row">
                        	<div class="col-md-12" style="display:none;">
									<div class="alert alert-success"><strong><span class="glyphicon glyphicon-send"></span> 留言成功發送 !</strong></div>	  
    								<div class="alert alert-danger"><span class="glyphicon glyphicon-alert"></span><strong> 錯誤！ 請檢查所有的輸入框</strong></div>
  							</div>
  						<form role="form" method="post" action="http://www2.prime40.ca/email-send.php" >
      					   ...
      					   <div class="form-group">
     					 	...
     					 	<div class="form-group">
       						    <label for="InputMessage">請留下言我們會盡快聯系您</label>
        						<div class="input-group">
      						...
      						<div class="form-group">
        						<label for="InputReal">What is 4+3? (請填寫答案)</label>
        						<div class="input-group">
