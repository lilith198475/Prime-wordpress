<?php get_header() ?>
    ...
    <div class="container">    
      ...
      <div class="row main-content-section about-us">      
        ...
        <div class="col-sm-4">
            <h4>关于 Prime 40</h4>
             <p><strong>百科迪保险</strong>, 诚意为40岁的人士提供最佳保险价钱及专业保险意见。我们明白在这个黄金佳期你所需要的保险项目和要求，提供一站式汽车房屋及旅游保险服务，为平日忙碌而热爱工作及家庭的你，解决保险上的烦恼。</p>
      ...
      <div class="row artice-title">
          <div class="col-md-6 artice-img">
           ...
           <div class="col-md-6">
               <h4><?php the_title(); ?></h4>
             <p> 
                   <?php echo mb_substr(get_the_content(),0,80,'utf-8'); ?> 
